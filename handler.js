...
function tweetAboutHowToFight() {
  ...
  const tweets = [
    "Do you really want to start paying " + isps[Math.floor(Math.random() * isp.length)] + " an ADDITION fee just to check your twitter feed? No? Then write and call your representatives now https://www.battleforthenet.com/ and them want to keep #NetNeutrality Then retweet to all your followers!",
